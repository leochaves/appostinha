...
class _LeaderboardScreenState extends State<LeaderboardScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      // busca todas as apostas resolvidas dos eventos deste torneio
      ...
      for (final row in data as List) {
        ...
        final username =
            (row['profiles'] as Map)['username'] as String? ?? 'Usuário';

        final e = map[userId] ??
            _Entry(userId: userId, username: username, wins: 0, total: 0);
        map[userId] = _Entry(
          userId: userId,
          username: username,
                  ...
                  : RefreshIndicator(
                      ...
                      child: _entries.isEmpty
                          ? ListView(children: const [
                              ...
                              Center(
                                child: Text(
                                  'Nenhum resultado ainda.\nOs rankings aparecem após os eventos serem resolvidos.',
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${entry.wins} acertos de ${entry.total} apostas',
          ...
          children: [
            Text(accuracy,
                style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w900,
                    color: rank <= 3 ? rankColor : _primary)),
            const Text('precisão',
